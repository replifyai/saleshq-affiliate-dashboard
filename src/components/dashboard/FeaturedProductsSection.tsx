      ...
      <div className="relative bg-card/60 backdrop-blur-sm border border-border/50 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
        ...
        <div className="p-6 space-y-4 flex-1 flex flex-col">
          ...
          <button
            ...
            className="w-full bg-primary-gradient hover:opacity-90 text-white py-4 rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
